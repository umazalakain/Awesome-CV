...
\begin{cvhonors}
    ...
    \cvhonor
      {Andrew McGettrick prize for outstanding performance (\textbf{£400})} % Award
      {University of Strathclyde} % Event
      {Glasgow} % Location
      {2018} % Date(s)
  
    \cvhonor
      {Best overall third year student (\textbf{£200})} % Award
...
\begin{cventries}
    \cventry
      ...
      {MirageOS retreat} % Organization/group
      {Morocco} % Location
      {2019} % Date(s)
      {
        \begin{cvitems}
